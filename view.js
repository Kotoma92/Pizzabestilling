...
function updateView() {
    ...
    <br>
    <button ${isOrderReady() ? '' : 'disabled'} onclick="alert('Du har bestillt en ${pizzaDiv.str} pizza med ${pizzaDiv.bread} Bunn, med ${pizzaDiv.fill} fyll som er ${pizzaDiv.shape}!');">Bestill!</button><br>
